    ...
    <div class="sec_pad <?php echo esc_attr($wrap_class) ?>">
        <div>
            ...
            <div id="vue-container">
                <plan-services inline-template :previous-services='JSON.parse("<?php echo $_POST['api_data']; ?>")'>
                    <div class="" v-cloak>
                        <loading
...
<!--                                                />-->
                                            ...
                                            <div class="form-container">
                                                <div v-if="service.Caculation_Type === 'User Count Basis'"  class="row form2">
                        ...
                        <div class="services-content">
                            <header-wizard inline-template>
                                <div class="progress-field">
                                    <div v-for="(step, index) in steps" :class="{'progress-step': true, 'active': index <= 3}" @click="goToStep(index, 3)">
                            ...
                            <div class="row2" v-if="!isLoading && !services">
                                <h2>Add-Ons are not available for the current Plan.</h2>
                            </div>
                                    ...
                                    >
                                        <div class="row2">
                                            <img
                                                    ...
                                                    alt=""
                                            />
                                            <h1 class="title2">{{ service.Add_Ons }}
