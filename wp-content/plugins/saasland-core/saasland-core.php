...
if ( !class_exists( 'Saasland_core' ) ) {
	...
	class Saasland_core {
		...
		private function register_widgets() {
            // Site Elements
            $widgets = array(
                'Subscribe_Form', 'Services_shapes', 'Solar_Integration', 'Integrations', 'Integrations_row', 'Pricing_table', 'Pricing_table_tabs', 'Pricing_table_tabs_carousel','Navbar', 'Hero_Section',
                'Hero_crm', 'Two_column_features', 'Services', 'Call_to_Action', 'Footer', 'Client_logos', 'Features', 'Bubble_features', 'Features_vertical', 'Prototype_features', 'Features_vertical', 'Prototype_features',
                'Tabs', 'Tabs_with_icon', 'Blog', 'Testimonial', 'Testimonial_bubble', 'Testimonial_ratting', 'Testimonial_single', 'Paired_images', 'Tabs_horizontal', 'Features_with_shapes', 'Features_with_image',
                'Features_with_image_white', 'Counter', 'Curve_counter', 'Circle_counter', 'Hero_app', 'Hero_seo', 'Hero_integration', 'Hero_videos', 'Hero_with_bg_img', 'Image_carousels', 'Downloads', 'Team', 'Map', 'Map2',
                'Processes', 'Hotspot', 'Portfolio', 'Portfolio_masonry', 'Login_form', 'Signup_form', 'Jobs', 'Icon_boxes', 'Single_video', 'Single_feature', 'Single_feature', 'Icons', 'Icon_dual', 'Seo_check_form',
                'Posts_carousel', 'Featured_image_with_shape', 'Slider', 'Serialized_features', 'Alerts_box', 'Faq', 'Pricing_table_comparison', 'Appart_hero', 'Appart_c2a', 'Appart_screen_feature', 'Appart_pricing_table',
                'Appart_app_info', 'Appart_testimonials', 'Appart_features', 'Appart_single_video', 'Appart_parallax_hero', 'Appart_parallax_hero', 'Appart_single_info_with_icon', 'Appart_shop_categories','Appart_products',
                'Ticket_plan', 'Hero_erp', 'Icon_with_featured_img', 'Domain_form', 'Locations', 'Table_tabs', 'Button_icons', 'Parallax_img_effect', 'Countdown', 'Event_schedule'
            );
