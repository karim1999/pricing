        ...
        $this->add_control(
            'btn_bg_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .footer a' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_font_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .footer a:hover' => 'color: {{VALUE}};',
                ],
                'condition' => [
        ...
        $this->add_control(
            'hover_bg_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .footer a:hover' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'style' => ['style_02', 'style_03', 'style_05', 'style_06', 'style_07', 'style_08', 'style_09']
                ]
        ...
        $this->add_control(
            'hover_border_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .footer a:hover' => 'border-color: {{VALUE}};',
                ],
                'condition' => [
                    'style' => ['style_02', 'style_03', 'style_07', 'style_08']
                ]
