...
$j(document).on('ready', function () {
     ...
     * Open quick view.
     */
    $j(document).on('click', '.lae-quick-view', function (e) {
        e.preventDefault();
    ...
    laeQVAddToCartHandler.prototype.onAddToCart = function (e) {
        ...
        var button = $j(this),
            ...
            variationId = $j('input[name="variation_id"]').val(),
            quantity = $j('input[name="quantity"]').val(),
            variationForm = $j(this).closest('.variations_form'),
