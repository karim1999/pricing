        ...
        if ($this->is_video_item()):
            ...
            elseif ($this->item_type == 'youtube' || $this->item_type == 'vimeo') :
                ...
                if (!empty($thumbnail_url)):
                    ...
                    $image_html = sprintf('<img data-no-lazy="1" src="%s" title="%s" alt="%s" class="lae-image %s"/>', esc_attr($thumbnail_url), esc_html($this->item['item_name']), esc_html($this->item['item_name']), lae_disable_lazy_load_classes());
